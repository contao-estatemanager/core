...
class SelectWizard extends Widget
{
	 ...
	 * @var array
	 */
	protected $arrFieldNames = array('field');

	/**
	 * Field labels
	 * @var array
	 */
	protected $arrFieldLabels = array('value');
	...
	public function generate()
	{
		...
		// Add the labels
		$strLabels = vsprintf('<thead><tr><th>%s</th><th></th></tr></thead>', [
		...
		return vsprintf('<table id="ctrl_%s" class="%s">%s<tbody class="sortable">%s</tbody></table>%s', [
			$this->strId,
			'tl_modulewizard cem_selectWizard',
			$strLabels,
			$strFields,
