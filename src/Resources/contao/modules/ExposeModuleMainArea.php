 ...
 */
class ExposeModuleMainArea extends ExposeModule
{
    /**
     * Template
     * @var string
     */
    protected $strTemplate = 'expose_mod_mainArea';
    ...
    public function generate()
    {
        if (TL_MODE == 'BE')
        {
            ...
            $objTemplate->wildcard = '### ' . mb_strtoupper($GLOBALS['TL_LANG']['FMD']['mainArea'][0], 'UTF-8') . ' ###';
